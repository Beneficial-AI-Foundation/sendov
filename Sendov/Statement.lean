...
* the elimination of every degree `n > 200`.
...
`0.8529` over the feasible range, at `n = 53`, `α = 17`.  For comparison, `R 5 0 ≈ 0.6458`
and `R 200 17 ≈ 0.1871`.  The feasibility constraint is binding at low degree: it caps
...
`5 ≤ n ≤ 200`, `0 ≤ α ≤ 17`, subject to the feasibility constraint `c ^ 2 ≤ A`. -/
theorem finite_range (n : ℕ) (α : ℝ) (hn : 5 ≤ n) (hn' : n ≤ 200)
    (hα : 0 ≤ α) (hα' : α ≤ 17) (hfeas : c n α ^ 2 ≤ A n α) :
    R n α < 1 := by
  sorry

/-- Equation `stat` of the blog post is infeasible on the remaining range
`5 ≤ n ≤ 200`, `0 ≤ α ≤ 17`, `c ^ 2 ≤ A`.  This is the form in which the claim is used. -/
theorem finite_range_contradiction (n : ℕ) (α : ℝ) (hn : 5 ≤ n) (hn' : n ≤ 200)
